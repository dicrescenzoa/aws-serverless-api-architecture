...
resource "aws_api_gateway_deployment" "api_gateway_deployment" {
  depends_on = [
    ...
    module.fastify-serverless-api-lambda.fastify_serverless_api_proxy_integration,
    module.fastify-serverless-api-lambda.fastify_serverless_api_root_integration,
  ]
